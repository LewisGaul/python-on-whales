...
from typing import Any, Dict, Iterator, List, Optional, Union, overload, Iterable, Tuple
...
class Pod(ReloadableObjectFromJson):
    ...
    def kill(self, *, signal: Optional[Union[int, str]] = None) -> None:
        ...
        """
        return PodCLI(self.client_config).kill(self, signal)
    ...
    def restart(self, *, time: Optional[Union[int, timedelta]] = None) -> None:
        ...
        information about the arguments.
        """
        return PodCLI(self.client_config).restart(self, time)

    def remove(
        self, *, force: bool = False, time: Optional[Union[int, timedelta]] = None
    ) -> None:
        """Remove this pod.
...
class PodCLI(DockerCLICaller):
    ...
    def inspect(self, /, x: Union[ValidPod, List[ValidPod]]) -> Union[Pod, List[Pod]]:
    ...
    def kill(
        self,
        /,
        x: Optional[Union[ValidPod, List[ValidPod]]] = None,
        *,
        all: bool = False,
        latest: bool = False,
    ...
    def remove(
        self,
        /,
        x: Union[ValidPod, List[ValidPod]],
        *,
        all: bool = False,
        force: bool = False,
        ignore: bool = False,
        ...
        Parameters:
            x: Single pod or list of pods to remove. You can use tags or
                `python_on_whales.Pod` objects.
            all: Remove all pods
